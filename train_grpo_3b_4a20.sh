# This one works for 3B GRPO on 4A20 GPUs
...
export EXPERIMENT_NAME=countdown-qwen2.5-3b--COLDSTART_countdown_1e-5--grpo
...
nohup bash ./scripts/train_tiny_zero_grpo_4a20_tang3.sh &>"./outputs/$EXPERIMENT_NAME/$(date +'%y%m%d-%H%M%S').nohupoutput"
