    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            ...
            for data in tqdm(self.train_dataloader,
                ...
                # validate
                if self.config.trainer.validate_every_n_steps > 0 and (global_step - 1) % self.config.trainer.validate_every_n_steps == 0:
                ...
                if global_step >= self.total_training_steps:
                    print(f'Reached total training steps {self.total_training_steps}, exiting...')
                    # validation
                    val_losses = []
